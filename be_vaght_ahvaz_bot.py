...
be_vaght_ahvaz_bot
-------------------
یک بات تلگرام ساده که:
1) وقتی کاربر /start را می‌زند، یک معرفی از کانال خبری نشان می‌دهد.
2) امکان ارسال «پیام ناشناس» به ادمین را فراهم می‌کند (هویت فرستنده برای ادمین نمایش داده نمی‌شود مگر خودتان بخواهید).

نیازمندی‌ها:
    pip install python-telegram-bot==21.4

پیش از اجرا، مقادیر بخش «تنظیمات» در پایین همین فایل را با اطلاعات خودتان پر کنید.
"""
...
BOT_TOKEN = "1234567890:AAExampleTokenReplaceThisWithYourOwn"
